              ...
              <FormItem className="flex flex-col gap-2.5">
                ...
                <FormControl>
                  <Input
                    ...
                    placeholder="Enter Podcast Title" {...field} />
                </FormControl>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <Select onValueChange={(value: VoiceType) => setVoiceType(value)}>
              ...
              <SelectContent className="text-16 border-none bg-black-1 font-bold text-white-1 focus:ring-orange-1">
                {
                  voiceCategories.map((categorie) => (
                    <SelectItem key={categorie} value={categorie} className="capitalize focus:bg-orange-1">{categorie}</SelectItem>
                  ))
                }
              </SelectContent>
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col gap-2.5">
                ...
                <FormControl>
                  <Textarea
                    className="input-class focus-visible:ring-offset-orange-1"
                    placeholder="Enter Podcast Description" {...field} />
                </FormControl>
                <FormMessage className="text-white-1"/>
              </FormItem>
            )}
